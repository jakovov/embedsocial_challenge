    ...
    .then((data) => {
        ...
        function showPost(obj) {
            ...
            div.innerHTML =
                ...
                obj.date + '</p></div></div><div class="topicon"><img class="" src="../icons/instagram-logo.svg"/></div></div><div class="card-img"><img class="card__image" src="' +
                obj.image + '"/></div><div class="card__inner"><p class="innerstyle" style="height:300px">' +
        ...
        function attachLikeEvent(element) {
            const card_inner2 = element.getElementsByClassName('card__inner2')[0];
        ...
        function show_hide() {
            ...
            collumns.addEventListener("click", (event) => {
                ...
                if (event.target.value === "1") {
                    ...
                    mainpreview[0].setAttribute("style", "width : 110%");
                    for (i = 0; i < innerstyle.length; i++) {
